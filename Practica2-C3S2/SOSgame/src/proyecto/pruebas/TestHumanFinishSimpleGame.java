...
public class TestHumanFinishSimpleGame {
    ...
    public void SOS_WinBlue(){
        ...
        assertEquals("BLUE IS THE WINNER",1,game.SOS_GUI("S", 0, 0, info, Slots, currentPlayer));
    }
    @Test
    public void SOS_WinRed(){
        ...
        info[2][2]=1;
        info[0][2] =1;
       assertEquals("RED IS THE WINNER",1,  game.SOS_GUI("S", 0, 2, info, Slots, currentPlayer));
