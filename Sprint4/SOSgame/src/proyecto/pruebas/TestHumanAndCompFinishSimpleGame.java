...
public class TestHumanAndCompFinishSimpleGame {
    ...
    @Test
    public void SOS_WinBlue_Human_Computerr(){
    ...
    @Test
    public void SOS_WinRed_Human_Computerr(){
        ClassScore.info = new int[3][3];
        for(int i=0;i<3;i++){
            for(int j=0;j<3;j++){
                ClassScore.setInfo(i,j,-1);
    ...
    @Test
    public void SOS_Draw_Human_Computerr(){
        ClassScore.info = new int[3][3];
        for(int i=0;i<3;i++){
            for(int j=0;j<3;j++){
                ClassScore.setInfo(i,j,-1);
